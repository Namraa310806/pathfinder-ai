import { z } from "zod";
import { resumeImprovementOutputSchema } from "./resume.js";
import { coverLetterOutputSchema } from "./cover-letter.js";
import { interviewQuestionsOutputSchema } from "./interview.js";
 ...
 */
export const resumeRoastOutputSchema = z.object({
  roast: z.string().min(10).max(5000),
  score: z.union([z.string(), z.number()]).transform(val => String(val)),
  fixes: z.array(z.string().min(1).max(500)).min(1).max(10),
}).strict();
